...
do $$
begin
  if not exists (select 1 from public.lotes) then
    insert into public.lotes (nome, price_cents, dt_inicio, dt_fim) values
      ('Lote Lançamento', 7500, '2025-09-01'::date, '2025-09-07'::date),
      ('1º Lote',         8500, '2025-09-08'::date, '2025-09-30'::date),
      ('2º Lote',         9500, '2025-10-01'::date, '2025-10-31'::date),
      ('3º Lote',        11500, '2025-11-01'::date, '2025-11-30'::date),
      ('Último Lote',    15000, '2025-12-01'::date, '2025-12-10'::date);
  end if;
end $$;
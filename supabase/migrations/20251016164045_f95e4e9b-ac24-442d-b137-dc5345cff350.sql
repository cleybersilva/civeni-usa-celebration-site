...
-- Note: app_role enum and some policies may already exist
-- ============================================

-- 1. Create enum if it doesn't exist (skip if already exists)
DO $$ BEGIN
...
-- 4. Drop old policy if exists and recreate
DROP POLICY IF EXISTS "Admin root can manage user roles" ON public.user_roles;

export const ptTranslations = {
  ...
  events: {
    ...
    location: "Local",
    certificateEmission: {
      pageTitle: "Emita seu certificado",
      congratulations: "Parabéns por ter chegado ao final do evento!",
      subtitle: "Agora é hora de emitir seu certificado!",
      shareLinkedIn: "Compartilhe no LinkedIn",
      followCiveni: "Siga o CIVENI 2025 nas redes",
      upcomingEvents: "próximos eventos",
      knowOur: "Conheça nossos",
      emailLabel: "E-mail cadastrado no evento",
      emailPlaceholder: "exemplo@email.com",
      fullNameLabel: "Nome completo (máx. 50 caracteres)",
      fullNamePlaceholder: "Nome que aparecerá no certificado",
      presenceConfirmation: "Confirmação de Presença",
      keywordsInstruction: "Digite as palavras-chave informadas durante o evento.",
      keywordsHighlight: "palavras-chave informadas",
      attentionMinimum: "Atenção: É necessário acertar pelo menos 2 de 3 palavras.",
      ...
      eventNotFoundDesc: "O evento solicitado não foi encontrado ou não possui certificados habilitados.",
      backToEvents: "Voltar para Eventos",
      certificateMock: "CERTIFICADO DE PARTICIPAÇÃO",
      certifiesName: "Certificamos que",
      certifiesParticipated: "participou do evento",
      signature: "Assinatura",
      yourNameHere: "[SEU NOME AQUI]"
    },
    certificateSuccess: {
      pageTitle: "Seu certificado está pronto!",
      congratulations: "Parabéns por ter chegado ao final do evento!",
      subtitle: "Agora é hora de emitir seu certificado!",
      shareLinkedIn: "Compartilhe no LinkedIn",
      followCiveni: "Siga o CIVENI 2025 nas redes",
      ...
      matchedAllKeywords: "Você acertou todas as palavras-chave e atingiu o mínimo necessário para receber o certificado.",
      matchedKeywords: "Você acertou {matched} de 3 palavras-chave, atingindo o mínimo necessário para receber o certificado.",
      ...
      code: "Código:",
      backToHome: "Voltar para a Home",
      noDataAvailable: "Nenhum certificado encontrado",
      noDataDesc: "Para acessar esta página, primeiro valide sua participação na tela de emissão de certificados.",

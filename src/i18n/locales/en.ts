export const enTranslations = {
  translation: {
    header: {
      ...
      submissionArticleConsortium: "Article/Consortium Submission",
      oralPresentation: "Oral Presentation List/Template",
      posterSessions: "Poster Sessions",
      manuscripts: "Video Submissions",
      templatesArticlesSlides: "Article/Slide Templates",
  ...
  works: {
    ...
    congressPresentation: {
      ...
      heroSubtitle: 'VCCU International Multidisciplinary Congress - Learn about the complete presentation of the event, its objectives and importance for world education',
      breadcrumbHome: 'Home',
    ...
    congressEvaluators: {
      pageTitle: 'III CIVENI 2025 Evaluators',
      heroSubtitle: 'Meet our renowned academic evaluators who guarantee the excellence and scientific quality of the International Multidisciplinary Congress',
      breadcrumbHome: 'Home',
      breadcrumbCongress: 'Congress',
      breadcrumbEvaluators: 'Evaluators',
      submitWorkButton: 'Submit Paper',
      registerButton: 'Register Now',
      excellenceTitle: 'Excellence in Scientific Evaluation',
      excellenceDescription: 'Our body of evaluators is composed of renowned doctors from national and international institutions, ensuring that all works submitted to III CIVENI 2025 are evaluated with the highest scientific and academic rigor, following international research standards.',
      rigorTitle: 'Scientific Rigor',
      rigorDescription: 'Evaluation based on international academic quality criteria',
      expertiseTitle: 'Multidisciplinary Expertise',
      expertiseDescription: 'Doctors specialized in various areas of knowledge',
      recognitionTitle: 'International Recognition',
      recognitionDescription: 'Evaluators from renowned national and international institutions',
      ourEvaluatorsTitle: 'Our Evaluators',
      ourEvaluatorsDescription: 'Meet the doctors who make up our renowned body of academic evaluators',
      evaluatorBadge: 'Evaluator',
      ctaTitle: 'Submit Your Paper',
      ctaDescription: 'Have your work evaluated by our renowned body of doctors and be part of the largest international multidisciplinary congress in the world',
    },
    congressCommittee: {
      pageTitle: 'Event Organizing Committee',
      heroSubtitle: 'Meet the dedicated professionals who make CIVENI a reality, working tirelessly to offer a world-class event',
      breadcrumbHome: 'Home',
      breadcrumbCongress: 'Congress',
      breadcrumbCommittee: 'Committee',
      registerButton: 'Register Now',
      viewSpeakersButton: 'View Speakers',
      organizingTitle: 'General Event Coordination',
      scientificTitle: 'Scientific Committee',
      operationalTitle: 'Operational Committee',
      acknowledgmentTitle: 'Special Thanks',
      acknowledgmentDescription: 'Our sincere thanks to all members of the organizing committee who dedicate their time and expertise to make CIVENI a reference event in the world of global education. Your commitment and dedication are fundamental to the success of the congress.',
      contactInfo: 'For more information, contact us',
    },
  },
  common: {
    loading: "Loading",

export const esTranslations = {
  translation: {
    header: {
      ...
      papers: "Trabajos",
      submission: "Envío",
      submissionArticleConsortium: "Envío Artículo/Consorcio",
      oralPresentation: "Lista/Plantilla Presentación Oral",
      posterSessions: "Sesiones de Póster",
      manuscripts: "Envío de Videos",
      templatesArticlesSlides: "Plantillas Artículos/Diapositivas",
  ...
  works: {
    ...
    congressPresentation: {
      ...
      heroSubtitle: 'Congreso Internacional Multidisciplinario de la VCCU - Conozca la presentación completa del evento, sus objetivos y la importancia para la educación mundial',
      breadcrumbHome: 'Inicio',
      breadcrumbCongress: 'Congreso',
      breadcrumbPresentation: 'Presentación',
      registerButton: 'Inscribirse',
      viewScheduleButton: 'Ver Programación',
    },
    congressEvaluators: {
      pageTitle: 'Evaluadores del III CIVENI 2025',
      heroSubtitle: 'Conozca a nuestros reconocidos evaluadores académicos que garantizan la excelencia y calidad científica del Congreso Internacional Multidisciplinario',
      breadcrumbHome: 'Inicio',
      breadcrumbCongress: 'Congreso',
      breadcrumbEvaluators: 'Evaluadores',
      submitWorkButton: 'Enviar Trabajo',
      registerButton: 'Inscribirse',
      excellenceTitle: 'Excelencia en Evaluación Científica',
      excellenceDescription: 'Nuestro cuerpo de evaluadores está compuesto por doctores reconocidos de instituciones nacionales e internacionales, garantizando que todos los trabajos presentados al III CIVENI 2025 sean evaluados con el más alto rigor científico y académico, siguiendo los estándares internacionales de investigación.',
      rigorTitle: 'Rigor Científico',
      rigorDescription: 'Evaluación basada en criterios internacionales de calidad académica',
      expertiseTitle: 'Experiencia Multidisciplinaria',
      expertiseDescription: 'Doctores especializados en diversas áreas del conocimiento',
      recognitionTitle: 'Reconocimiento Internacional',
      recognitionDescription: 'Evaluadores de instituciones nacionales e internacionales reconocidas',
      ourEvaluatorsTitle: 'Nuestros Evaluadores',
      ourEvaluatorsDescription: 'Conozca a los doctores que componen nuestro reconocido cuerpo de evaluadores académicos',
      evaluatorBadge: 'Evaluador',
      ctaTitle: 'Envíe Su Trabajo',
      ctaDescription: 'Tenga su trabajo evaluado por nuestro reconocido cuerpo de doctores y sea parte del mayor congreso internacional multidisciplinario del mundo',
    },
    congressCommittee: {
      pageTitle: 'Comisión Organizadora del Evento',
      heroSubtitle: 'Conozca a los profesionales dedicados que hacen realidad el CIVENI, trabajando incansablemente para ofrecer un evento de excelencia mundial',
      breadcrumbHome: 'Inicio',
      breadcrumbCongress: 'Congreso',
      breadcrumbCommittee: 'Comité',
      registerButton: 'Inscribirse',
      viewSpeakersButton: 'Ver Conferenciantes',
      organizingTitle: 'Coordinación General del Evento',
      scientificTitle: 'Comité Científico',
      operationalTitle: 'Comité Operacional',
      acknowledgmentTitle: 'Agradecimiento Especial',
      acknowledgmentDescription: 'Nuestro sincero agradecimiento a todos los miembros de la comisión organizadora que dedican su tiempo y experiencia para hacer del CIVENI un evento de referencia en el universo de la educación mundial. Su compromiso y dedicación son fundamentales para el éxito del congreso.',
      contactInfo: 'Para más información, contáctenos',
    },
  },
  common: {
    loading: "Cargando",

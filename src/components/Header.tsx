        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-8">
            <div className="flex items-center">
              <Link to="/">
                <img 
                  src={resolveAssetUrl("/src/assets/civeni-2025-logo.png")} 
                  alt="III Civeni 2025 Logo" 
                  className="h-14 w-auto"
                  onError={(e) => {
                    console.warn('Failed to load header logo');
                    // Try fallback logo if main logo fails
                    e.currentTarget.src = resolveAssetUrl("/lovable-uploads/0f616daa-6e2b-4e06-95c9-f2caa84c32d6.png");
                  }}
                />
              </Link>
            </div>

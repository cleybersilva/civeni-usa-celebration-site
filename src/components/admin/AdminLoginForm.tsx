      ...
      <div className="fixed top-0 right-0 z-50 p-4">
        <div className="relative" ref={dropdownRef}>
          <button
            ...
            className="flex items-center space-x-2 text-white hover:text-white transition-colors bg-civeni-blue bg-opacity-80 px-3 py-2 rounded-md hover:bg-civeni-red hover:bg-opacity-90 border border-white border-opacity-30"
          >

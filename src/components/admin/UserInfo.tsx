...
const UserInfo: React.FC = () => {
  ...
  return (
    <Card className="mb-4 md:mb-5 lg:mb-6 overflow-hidden border-none shadow-lg">
      <CardHeader 
        className="pb-2 md:pb-3 px-3 md:px-4 lg:px-6"
        style={{
          background: 'linear-gradient(to right, #021b3a, #731b4c, #c51d3b, #731b4c, #021b3a)'
        }}
      >
        <CardTitle className="text-sm md:text-base lg:text-lg flex items-center gap-2 text-white drop-shadow-md">
          {userTypeInfo.icon}
      ...
      <CardContent className="pt-3 md:pt-4 px-3 md:px-4 lg:px-6">
        <div className="flex flex-col gap-3">
          ...
          <div className="min-w-0">
            <p className="text-sm md:text-base lg:text-lg font-bold text-gray-900 dark:text-white truncate">{user.email}</p>

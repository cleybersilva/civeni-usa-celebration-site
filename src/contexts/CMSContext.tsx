    ...
    try {
      ...
      for (let i = 0; i < bannerSlides.length; i++) {
        ...
        const slidePayload: any = {
          ...
          title: slide.title || '',
          title_en: slide.titleEn || null,
          title_es: slide.titleEs || null,
          title_tr: slide.titleTr || null,
          subtitle: slide.subtitle || '',
          subtitle_en: slide.subtitleEn || null,
          subtitle_es: slide.subtitleEs || null,
          subtitle_tr: slide.subtitleTr || null,
          description: slide.description || '',
          description_en: slide.descriptionEn || null,
          description_es: slide.descriptionEs || null,
          description_tr: slide.descriptionTr || null,
          bg_image: finalBgImage || '',
          button_text: slide.buttonText || '',
          button_text_en: slide.buttonTextEn || null,
          button_text_es: slide.buttonTextEs || null,
          button_text_tr: slide.buttonTextTr || null,

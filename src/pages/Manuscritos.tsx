            ...
            <Card>
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-lg font-semibold mb-2">
                  {t('works.manuscripts.noContent', 'Conteúdo em breve')}
                </h3>
                <p className="text-muted-foreground">
                  {t('works.manuscripts.noContentDescription', 'As informações sobre manuscritos serão publicadas em breve.')}
                </p>
              </CardContent>
            </Card>
           )}

            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
              ...
              {Object.entries(committeesData).map(([key, committee]) => (
                <TabsContent key={key} value={key}>
                  ...
                  <div className={`grid gap-8 ${key === 'coordenacao' ? 'grid-cols-1 md:grid-cols-3 max-w-3xl mx-auto' : key === 'cientifico' ? 'grid-cols-1 md:grid-cols-3 lg:grid-cols-5 max-w-6xl mx-auto' : 'grid-cols-1 md:grid-cols-3 max-w-3xl mx-auto'}`}>

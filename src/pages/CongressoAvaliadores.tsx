          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <nav className="mb-6 md:mb-8 text-xs md:text-sm">
              <ol className="flex items-center space-x-2">
                ...
                <li><Link to="/congresso/apresentacao" className="hover:text-blue-200 transition-colors">{t('congress.evaluators.breadcrumb.congress', 'Congresso')}</Link></li>
                <li className="text-blue-200">›</li>
                <li>{t('congress.evaluators.breadcrumb.evaluators', 'Avaliadores')}</li>
              </ol>
            </nav>
            
            <div className="text-center max-w-4xl mx-auto">
              <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-6xl font-bold mb-4 md:mb-6 font-poppins">
                {t('congress.evaluators.hero.title', 'Avaliadores do III CIVENI 2025')}
              </h1>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl mb-6 md:mb-8 max-w-3xl mx-auto text-blue-100 px-2">
                {t('congress.evaluators.hero.subtitle', 'Conheça nossos renomados avaliadores acadêmicos que garantem a excelência e qualidade científica do Congresso Internacional Multidisciplinar')}
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center px-4">
                <Link to="/submissao-trabalhos" className="w-full sm:w-auto">
                  <button className="w-full sm:w-auto bg-white text-civeni-blue hover:bg-white/90 px-6 py-2.5 md:px-8 md:py-3 rounded-full text-sm md:text-base font-semibold transition-colors flex items-center justify-center gap-2">
                    ...
                    {t('congress.evaluators.cta.submitWork', 'Submeter Trabalho')}
                  </button>
                </Link>
                ...
                <Link to="/inscricoes" className="w-full sm:w-auto">
                  <button className="w-full sm:w-auto border-white text-white hover:bg-white/20 border-2 px-6 py-2.5 md:px-8 md:py-3 rounded-full text-sm md:text-base font-semibold transition-colors flex items-center justify-center gap-2">
                    ...
                    {t('congress.evaluators.cta.register', 'Fazer Inscrição')}
                  </button>
                </Link>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center mb-12 md:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-civeni-blue mb-4 md:mb-6 font-poppins">
                {t('congress.evaluators.excellence.title', 'Excelência na Avaliação Científica')}
              </h2>
              <div className="bg-gradient-to-r from-civeni-blue/10 to-civeni-red/10 rounded-xl md:rounded-2xl p-6 md:p-8 mb-6 md:mb-8">
                <p className="text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
                  {t('congress.evaluators.excellence.description', 'Nosso corpo de avaliadores é composto por doutores renomados de instituições nacionais e internacionais, garantindo que todos os trabalhos submetidos ao III CIVENI 2025 sejam avaliados com o mais alto rigor científico e acadêmico, seguindo os padrões internacionais de pesquisa.')}
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-3 gap-6">
                <Card className="border-0 bg-gradient-to-br from-blue-50 to-indigo-50 hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-bold text-civeni-blue mb-2">{t('congress.evaluators.features.rigor.title', 'Rigor Científico')}</h3>
                    <p className="text-gray-600">{t('congress.evaluators.features.rigor.description', 'Avaliação baseada em critérios internacionais de qualidade acadêmica')}</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-0 bg-gradient-to-br from-green-50 to-emerald-50 hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-bold text-civeni-blue mb-2">{t('congress.evaluators.features.expertise.title', 'Expertise Multidisciplinar')}</h3>
                    <p className="text-gray-600">{t('congress.evaluators.features.expertise.description', 'Doutores especializados em diversas áreas do conhecimento')}</p>
                  </CardContent>
                </Card>
                ...
                <Card className="border-0 bg-gradient-to-br from-purple-50 to-violet-50 hover:shadow-lg transition-shadow">
                  <CardContent className="p-6 text-center">
                    ...
                    <h3 className="text-xl font-bold text-civeni-blue mb-2">{t('congress.evaluators.features.recognition.title', 'Reconhecimento Internacional')}</h3>
                    <p className="text-gray-600">{t('congress.evaluators.features.recognition.description', 'Avaliadores de instituições nacionais e internacionais renomadas')}</p>
                  </CardContent>
                </Card>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-10 md:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-civeni-blue mb-4 md:mb-6 font-poppins">
                {t('congress.evaluators.grid.title', 'Nossos Avaliadores')}
              </h2>
              <p className="text-base md:text-lg lg:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed px-2">
                {t('congress.evaluators.grid.subtitle', 'Conheça os doutores que compõem nosso renomado corpo de avaliadores acadêmicos')}
              </p>
            </div>
                ...
                <Card key={evaluator.id} className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 border-0 bg-white relative overflow-hidden">
                  ...
                  <CardContent className="p-6 text-center relative z-10">
                    ...
                    <div className="flex items-center justify-center text-civeni-blue font-semibold opacity-0 group-hover:opacity-100 transition-opacity duration-300 mt-3">
                      ...
                      {t('congress.evaluators.grid.evaluatorLabel', 'Avaliador')}
                    </div>
                  </CardContent>
                </Card>
              ))}
        ...
        <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-r from-civeni-blue via-civeni-blue to-civeni-red relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white mb-4 md:mb-6 font-poppins px-2">
              {t('congress.evaluators.ctaSection.title', 'Submeta Seu Trabalho')}
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-blue-100 mb-8 md:mb-10 max-w-3xl mx-auto leading-relaxed px-2">
              {t('congress.evaluators.ctaSection.description', 'Tenha seu trabalho avaliado por nosso renomado corpo de doutores e faça parte do maior congresso internacional multidisciplinar do mundo')}
            </p>

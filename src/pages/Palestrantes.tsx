                        ...
                        if (pathIndex < fallbackPaths.length) {
                          ...
                          testImg.onerror = () => {
                            ...
                            if (pathIndex < fallbackPaths.length) {
                              ...
                              e.currentTarget.src = 'data:image/svg+xml;base64,';
                            }
                          };

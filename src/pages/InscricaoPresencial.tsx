        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              <div className="bg-gradient-to-br from-civeni-blue to-blue-600 p-8 text-white text-center">
              ...
              <div className="p-8">
                <div className="space-y-6">
                  <div className="border-l-4 border-civeni-blue pl-6 text-center">
                  ...
                  <div className="border-l-4 border-civeni-green pl-6 text-center">
                  ...
                  <div className="border-l-4 border-civeni-red pl-6 text-center">
